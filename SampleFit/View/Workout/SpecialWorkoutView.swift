...
class specialWorkoutTimer: ObservableObject{
...
struct SpecialWorkoutView: View {
...
struct SpecialWorkoutView_Previews: PreviewProvider {
    static var userData = UserData()
    static var previews: some View {
        SpecialWorkoutView(privateInformation: PrivateInformation.examplePrivateInformation,publicInformation: userData.publicProfile, categoryName: "Yoga", categoryIndex: 1.5).environmentObject(userData)
    }
}
